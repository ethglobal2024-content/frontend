...
const apiKey = process.env.NEXT_PUBLIC_AIRSTACK_API_KEY || process.env.REACT_APP_AIRSTACK_API_KEY;
if (!apiKey) {
  throw new Error("NEXT_PUBLIC_AIRSTACK_API_KEY is not set in environment variables");
}
init(apiKey);
